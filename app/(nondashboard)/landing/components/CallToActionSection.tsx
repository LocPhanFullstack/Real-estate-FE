        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div>
            <p className="text-white mb-3">
              Discover a wide range of properties in your desire location.
            </p>
            <div className="flex justify-center md:justify-start gap-4">
              <button
                onClick={handleScrollToTop}
                className="inline-block cursor-pointer text-primary-700 bg-white rounded-lg px-6 py-3 font-semibold hover:bg-primary-500 hover:text-primary-50"
              >
                Search
              </button>
              <Link
